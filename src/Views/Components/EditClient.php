...
">
    ...
    <form method="post" action="?action=store" class="img-fluid text-dark border border-dark border border-3 text-white p-2 m-5 d-flex justify-content-center w-100 " style="background-image: url('https://raw.githubusercontent.com/lauracastelao/image/main/assets/fondo.png')" ;>
        ...
        <div class="name_theme d-flex flex-column">
            <div class="card border border-dark border border-3 " style="width: 30rem; ">
                ...
                <label for="exampleFormControlInput1" class="form-label     text-dark"><strong>Name</strong>
               </label>
                    <input name="client" class="form-control" id="Input1" value="<?php echo ($myCliente->getclient()); ?>">

                <div class="mb-2">
                    <label for="exampleFormControlInput1" class="form-label text-dark"><strong>Theme</strong></label>
                    ...
                    <div class="description_buttons d-flex flex-column">
                        <div class="mb-4">
                            <label for="exampleFormControlInput1" class="form-label text-dark"><strong>Description</strong></label>
                            <textarea name="description" class="form-control" id="Textarea1" rows="7" value="<?php echo ($myCliente->getdetail()); ?>"></textarea>
