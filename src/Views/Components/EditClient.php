...
<body class="d-flex flex-column" style="background-image: url('https://mdbootstrap.com/img/Photos/Others/images/2.jpg');
            height: 100vh"> 
        ...
        <div class="mb-4">
            ...
            <textarea name="description" class="form-control" id="Textarea1" rows="8" value="<?php echo($myCliente->getdetail()); ?>"></textarea>
        </div>
